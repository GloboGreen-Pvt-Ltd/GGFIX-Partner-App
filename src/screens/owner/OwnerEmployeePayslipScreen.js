...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .shop-head { text-align: center; padding-bottom: 14px; border-bottom: 2px solid #16BB05; }
    ...
    .doc-title-month { font-size: 18px; font-weight: 800; color: #16BB05; margin-top: 2px; }
    .status-pill {
      display: inline-block; padding: 3px 10px; border-radius: 999px;
      font-size: 10px; font-weight: 800; letter-spacing: 0.5px;
      color: #fff;
    }
    .status-paid { background: #16BB05; }
    ...
    thead th {
      background: #16BB05; color: #FFFFFF; padding: 8px 10px; text-align: left;
    ...
    .net-row td { background: #E6F7E3; color: #087A0A; font-size: 13px; }
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content}>
        {loading ? (
          <ActivityIndicator size="large" color="#087A0A" style={{ marginVertical: 40 }} />
        ) : (
          <>
            {/* Hero — month + employee */}
            ...
            <View style={styles.attendanceRow}>
              ...
              <View style={[styles.attendanceTile, { backgroundColor: '#F0F8EF' }]}>
                <Ionicons name="briefcase" size={22} color="#16BB05" />
            ...
            <View style={styles.actionRow}>
              ...
              >
                {busy === 'download' ? (
                  <ActivityIndicator size="small" color="#087A0A" />
                ) : (
                  <>
                    <Ionicons name="download-outline" size={16} color="#087A0A" />
...
const styles = StyleSheet.create({
  ...
  empty: { fontSize: 13, color: '#667066', textAlign: 'center', marginTop: 24 },
  ...
  heroStatusPaid: { backgroundColor: '#087A0A' },
  ...
  payoutLabel: { fontSize: 12.5, color: '#667066', fontWeight: '600', letterSpacing: 0.3 },
  payoutAmount: { fontSize: 34, fontWeight: '800', color: '#087A0A', marginTop: 6 },
  payoutSplit: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: 16,
  ...
  payoutSplitSep: { width: 1, height: 32, backgroundColor: '#E2E8E2' },
  payoutSplitLabel: { fontSize: 11.5, color: '#8FA08F', fontWeight: '600' },
  payoutSplitValue: { fontSize: 16, fontWeight: '800', color: '#172117', marginTop: 3 },

  sectionHeader: { fontSize: 18, fontWeight: '800', color: '#172117', marginTop: 18, marginBottom: 12 },
  ...
  attendanceValue: { fontSize: 22, fontWeight: '800', color: '#172117', marginTop: 10 },
  attendanceLabel: { fontSize: 12, color: '#667066', fontWeight: '600', marginTop: 2 },
  ...
  breakdownLabel: { fontSize: 15, fontWeight: '800', color: '#172117' },
  breakdownSub: { fontSize: 12, color: '#8FA08F', marginTop: 2 },
  breakdownValue: { fontSize: 15, fontWeight: '800', color: '#172117' },
  breakdownValueEmphasize: { color: '#087A0A', fontWeight: '800' },
  breakdownDivider: { height: 1, backgroundColor: '#EFF5EE' },
  ...
  actionBtnSecondary: { backgroundColor: '#FFFFFF', borderWidth: 1.5, borderColor: '#087A0A' },
  actionBtnSecondaryText: { color: '#087A0A', fontSize: 14, fontWeight: '800' },
  actionBtnPrimary: { backgroundColor: '#087A0A' },
