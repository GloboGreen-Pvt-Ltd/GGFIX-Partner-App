...
const STATUS_COLORS = {
  ...
  WEEK_OFF: '#7ED957',   // light pink
  HOLIDAY: '#087A0A',    // green
};
const RING_COLORS = {
  present: '#087A0A',
  late: '#F59E0B',
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {loading && !data ? (
            <ActivityIndicator size="large" color="#087A0A" style={{ marginVertical: 24 }} />
          ) : (
            <>
              {/* Stat ring circles */}
...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 17, fontWeight: '800', color: '#172117' },
  ...
  statRingValue: { fontSize: 15, fontWeight: '800', color: '#172117' },
  ...
  calCellNum: { fontSize: 15, fontWeight: '700', color: '#172117' },
  calCellSunday: { color: '#DC2626' },
  calCellToday: { color: '#087A0A', fontWeight: '800' },
  ...
  legendText: { fontSize: 11, color: '#172117', fontWeight: '500' },
  ...
  dailyTitle: { fontSize: 18, fontWeight: '800', color: '#172117' },
  dailyMonthPill: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  dailyMonthText: { fontSize: 13, fontWeight: '800', color: '#087A0A' },
  dailyMonthBtn: {
    backgroundColor: '#087A0A',
    width: 30,
    height: 30,
  ...
  dayLeftAccent: { width: 4, backgroundColor: '#087A0A' },
  ...
  dayDate: { fontSize: 13, fontWeight: '800', color: '#172117' },
  dayPill: {
  ...
  dayPillWeekOff: { backgroundColor: '#087A0A' },
  ...
  dayCol: { flex: 1 },
  dayColDivider: { width: 1, height: 30, backgroundColor: '#E2E8E2', marginHorizontal: 6 },
  dayColValue: { fontSize: 15, fontWeight: '800', color: '#087A0A' },
  dayColValueLate: { color: '#DC2626' },
  dayColLabel: { fontSize: 11, color: '#667066', marginTop: 3 },

  empty: { fontSize: 13, color: '#667066', textAlign: 'center', paddingVertical: 20 },
});
