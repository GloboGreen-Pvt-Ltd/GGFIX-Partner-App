...
function statusMeta(rawStatus, type) {
  ...
  if (s === 'SOLD' || s === 'COMPLETED') {
    return { short: sell ? 'Sold' : 'Done', accent: BRAND_GREEN_DARK, tint: '#E6F7E3', dot: BRAND_GREEN };
  }
  if (s === 'CANCELLED' || s === 'CANCELED') {
    return { short: 'Cancelled', accent: '#B91C1C', tint: '#FEE2E2', dot: '#DC2626' };
  }
...
function OrderCard({ item, showPrice, onPress }) {
  ...
  return (
    ...
    >
      <View
        style={{
          width: rs(76), height: rs(76), borderRadius: rs(16),
      ...
      >
        {item.imageUrl ? (
          <Image source={{ uri: item.imageUrl }} style={{ width: rs(76), height: rs(76) }} resizeMode="cover" />
        ) : (
          <Smartphone size={rs(30)} color={BRAND_GREEN_DARK} />
        )}
      </View>
      ...
      <View className="flex-1 pr-2">
        <View className="flex-row items-center justify-between mb-1">
          <Text
            ...
            style={{ fontSize: rf(11.5), color: '#8FA08F', letterSpacing: 0.4 }}
            numberOfLines={1}
          >
            #GGFIX{orderId}
          </Text>
    ...
    <View className="flex-1" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        >
          <View className="flex-row items-center" style={capStyle}>
            ...
            <Pressable
              ...
              style={{ backgroundColor: searchOpen ? BRAND_GREEN_DARK : '#EFF5EE' }}
            >
              {searchOpen
      ...
      <View className="px-4 mt-3">
        <View
          ...
          style={[{ borderWidth: 1, borderColor: '#E2E8E2' }, capStyle]}
        >
          {['Buy', 'Sell'].map((t) => {
            const active = tab === t;
      ...
      {loading ? (
        ...
        <View className="flex-1 items-center justify-center px-8">
          ...
          >
            <ShoppingBag size={rs(32)} color={BRAND_GREEN_DARK} />
          </View>
          <Text className="font-extrabold text-gray-700" style={{ fontSize: rf(13.5) }}>
