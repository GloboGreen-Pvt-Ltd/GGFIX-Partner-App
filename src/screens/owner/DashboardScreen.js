...
const QUICK_ACTIONS = [
  ...
  // Plain Box, per the reference — PackageCheck's tick read as "completed"
  // rather than "all bookings", which is what this tile actually opens.
  { key: 'Bookings', label: 'Bookings', icon: Box, color: C.tone },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.groupedBg }}>
      ...
      >
        ...
        >
          {/* Avatar → account sheet. Its own glass ring keeps it legible over
