    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        {loading && list.length === 0 && (
          <ActivityIndicator size="small" color="#087A0A" style={{ marginVertical: 20 }} />
        )}
        ...
        {recentInProcess ? (
          ...
          <View style={styles.emptyCard}>
            <Ionicons name="checkmark-done-outline" size={26} color="#087A0A" />
            ...
            {isInProcess && (
              <View style={[styles.statusBadge, { backgroundColor: '#E6F7E3' }]}>
                {refreshing ? (
                  ...
                  <Ionicons name="refresh" size={14} color="#087A0A" />
                )}
              </View>
            )}
            {isCompleted && (
...
const styles = StyleSheet.create({
  ...
  taskAccent: { width: 4, backgroundColor: '#087A0A' },
  ...
  taskDate: { fontSize: 14, fontWeight: '800', color: '#172117' },
  taskTracking: { fontSize: 12, color: '#8FA08F', fontWeight: '600' },
  taskMiddleRow: { marginTop: 6 },
  taskDevice: { fontSize: 13, color: '#172117' },
  taskAssignee: { fontSize: 11.5, color: '#087A0A', fontWeight: '700', marginTop: 2 },
  taskBottomRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  taskStep: { fontSize: 13.5, fontWeight: '800' },
  taskFooter: { fontSize: 11.5, color: '#8FA08F', marginTop: 3 },
  ...
  emptyTitle: { fontSize: 14, fontWeight: '800', color: '#172117', marginTop: 8 },
