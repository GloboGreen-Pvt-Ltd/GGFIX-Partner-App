      ...
      <SafeAreaView edges={['top']} style={{ backgroundColor: '#FFFFFF' }}>
        ...
        >
          <View className="flex-row items-center">
            ...
            >
              {isShopLogin ? <Store size={11} color="#172117" /> : <Crown size={11} color="#172117" />}
              <Text
            ...
            {canAddShop ? (
              ...
              >
                <View
                  ...
                  style={{ backgroundColor: '#E6F7E3' }}
                >
                  <Plus size={16} color={BRAND_GREEN_DARK} />
                </View>
                <View className="flex-1">
                  <Text
                    className="text-[14px] font-extrabold"
                ...
                <ChevronRight size={16} color={BRAND_GREEN_DARK} />
              </Pressable>
            ) : null}
            </ScrollView>
            {switching ? (
...
function AppLockRow() {
  ...
  return (
    <View className="flex-row items-center px-3 py-3.5">
      <View className="h-10 w-10 rounded-xl items-center justify-center mr-3" style={{ backgroundColor: '#E6F7E3' }}>
