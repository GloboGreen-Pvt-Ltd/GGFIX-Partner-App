      ...
      style={[
        {
          ...
          paddingBottom: asDialog ? SPACING.lg : r.insets.bottom + SPACING.lg,
          paddingHorizontal: SPACING.lg,
          // Never taller than the window minus its insets, or a long sheet in
          // landscape runs off both ends with no way to reach the buttons.
          maxHeight: r.height - r.insets.top - (asDialog ? SPACING.xl * 2 : 0),
        },
        contentStyle,
      ]}
    >
